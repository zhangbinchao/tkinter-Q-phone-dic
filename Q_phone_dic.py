...
def layout(root):
	...
	#第一行按钮
	button750=tkinter.Button(root,text='750',width=6,bg='PaleGreen',command=display('750').jia)
	button751 = tkinter.Button(root, text='751', width=6,bg='PaleGreen',command=display('751').jia)
	button755 = tkinter.Button(root, text='755', width=6,bg='PaleGreen',command=display('755').jia)
